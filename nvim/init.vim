...
nmap <F3> <Esc>:w <bar> <Esc>:new <bar> :term bash # <CR>A
imap <F3> <Esc>:w <bar> <Esc>:new <bar> :term bash # <CR>A

"nmap <Esc>:w<Enter>:! bash %<Return>
...
" F29 == control-F5
nmap <F5> <Esc>:w <bar> <Esc>:new <bar> :term python3 # <CR>A
imap <F5> <Esc>:w <bar> <Esc>:new <bar> :term python3 # <CR>A

noremap <Leader>ipy <Esc>:w <bar> <Esc>:new <bar> :term ipython3 # -i <CR>A
noremap <Leader>p <Esc>:w <bar> <Esc>:new <bar> :term python3 -i # <CR>
...
" Treesitter for prettier syntax highlighting
...
" Command to show alphabetical marks
command Marks :marks abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ

" Practice section for abbreviations
:iabbrev @@ shassouneh@guardanthealth.com

" Git commands
" Set up Git commands using the split terminal
...
" Set up a go-to-definition function to new tab
...
" Set up floating window keymaps
let g:floaterm_keymap_toggle = '<F36>'
